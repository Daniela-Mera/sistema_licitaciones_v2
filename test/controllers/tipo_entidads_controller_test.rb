...
class TipoEntidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_entidad" do
    assert_difference("TipoEntidad.count") do
      post tipo_entidads_url, params: { tipo_entidad: { descripcion: @tipo_entidad.descripcion, entidad: @tipo_entidad.entidad } }
    end
  ...
  test "should update tipo_entidad" do
    patch tipo_entidad_url(@tipo_entidad), params: { tipo_entidad: { descripcion: @tipo_entidad.descripcion, entidad: @tipo_entidad.entidad } }
